...
_G.packer_plugins = {
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/logan/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/logan/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
